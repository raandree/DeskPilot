...
| FR-PA5 | M | Offer **Run it** and **No**. There is **no Turn-wide grant**: every command the safe-list does not cover is answered on its own merits, so two identical risky commands in one Turn prompt twice. |
