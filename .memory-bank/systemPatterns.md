...
- Repeat isolated trials; separate capability from all-trials reliability.
  Canonicalize fixture roots; reject links and pass validated ids/paths as data.
  Retain safety failures. Failed child stop/capture retains owned state and
  blocks more live trials; only verified cleanup permits deletion.
